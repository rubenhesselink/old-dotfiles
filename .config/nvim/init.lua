...
-- NOTE: Re-enable left, right, up and down keys when I am used to moving with h, l, k and j
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			require("telescope").setup({
				...
				defaults = {
					file_ignore_patterns = { "node_modules", "env", "venv", ".venv" },
				},
			})
	...
	-- Harpoon is a bookmarking plugin that allows you to quickly jump between files
	{
